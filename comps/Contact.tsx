    ...
    <Section id="Contact" title="Contact">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="px-5 py-2.5 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition-colors"
          >
            Send Message
          </button>
        </form>
        ...
        <div className="text-white/90">
          <p className="leading-relaxed">
            ...
            opportunities. Feel free to reach out on any of my socials below as
            well.
          </p>
