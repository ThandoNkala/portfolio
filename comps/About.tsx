    ...
    <Section id="About" title="About Me">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-14 items-start">
        <div className="md:col-span-2">
          <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-2xl overflow-hidden ring-2 ring-blue-500/40">
            <Image
              src="/me.png"
              alt="Profile"
              fill
        ...
        <div className="md:col-span-3 text-white/90 space-y-8">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-white/90">
              <li>Built a calculator web app using HTML to sharpen logic + UI structure. <a href="#" className="text-blue-400 hover:underline">(GitHub)</a></li>
              <li>Designed a coffee website project (using SCSS) to practice styling and layout finesse. <a href="#" className="text-blue-400 hover:underline">(GitHub)</a></li>
              <li>Created a timer demo and portfolio “style” project to explore interactions and design. <a href="#" className="text-blue-400 hover:underline">(GitHub)</a></li>
